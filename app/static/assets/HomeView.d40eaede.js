import { c as createComponent, a as computed, h, b as hSlot, g as getCurrentInstance, u as hUniqueSlot, $ as QIcon, r as ref, w as watch, ap as onBeforeMount, o as onMounted, W as onActivated, V as onDeactivated, f as onBeforeUnmount, j as listenOpts, t as hMergeSlot, aq as useSizeProps, ar as useSize, a9 as vmHasRouter, af as History, as as isNumber, at as isDate, au as isObject, m as nextTick, av as injectMultipleProps, ab as injectProp, Q as QBtn, aw as defineComponent, ax as toRefs, X as toRef, v as openBlock, H as createElementBlock, Z as Fragment, _ as renderList, E as createVNode, y as withCtx, A as createBaseVNode, I as toDisplayString, ay as unref, x as createBlock, z as createCommentVNode } from "./index.3ce55368.js";
import { g as getScrollTarget, E as QCardSection, D as QCard, F as QInput } from "./QDialog.ec1e5a72.js";
import { u as useVirtualScrollProps, a as useVirtualScroll, b as useCheckboxProps, c as useCheckboxEmits, d as useCheckbox, e as commonVirtPropsList, Q as QSelect, f as QSeparator, g as QBadge } from "./use-checkbox.12b2d847.js";
import { Q as QList } from "./QList.4dddd6bc.js";
...
qe.install = ii;
const _hoisted_1$1 = { class: "row justify-evenly" };
const _hoisted_2$1 = { class: "text-h5 q-mt-sm q-mb-xs" };
const _hoisted_3$1 = { class: "text-caption text-grey" };
const _sfc_main$1 = {
  __name: "HomeViewKPI",
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(kpi.value, (k) => {
                    ...
                    createVNode(QCardSection, { class: "q-pt-xs" }, {
                      default: withCtx(() => [
                        createBaseVNode("div", _hoisted_2$1, [
                          createBaseVNode("b", null, toDisplayString(k.value), 1)
                        ]),
                        createBaseVNode("div", _hoisted_3$1, toDisplayString(k.name), 1)
                      ]),
                      _: 2
                    }, 1024)
                  ]),
...
const _hoisted_3 = { class: "col-12 q-pt-lg q-px-xl" };
...
const _sfc_main = Object.assign({
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      timerId = setInterval(() => loadState(), 2e3);
    });
    onBeforeUnmount(() => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(_sfc_main$1, {
          workloadStates: unref(workloadStates),
          workloadsPerAgent: workloadsPerAgent.value,
          dependencies: dependencies.value,
          workloadsPerRuntime: workloadsPerRuntime.value
        }, null, 8, ["workloadStates", "workloadsPerAgent", "dependencies", "workloadsPerRuntime"]),
        createBaseVNode("div", _hoisted_1, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(charts), (chart) => {
            return openBlock(), createElementBlock("div", {
              key: chart.name,
              class: "col-3"
            }, [
            ...
            createVNode(QTable, {
              ...
              "body-cell-Tags": withCtx((props) => [
                createVNode(QTd, { props }, {
                  default: withCtx(() => [
                    props.value ? (openBlock(), createBlock(QBadge, {
                      key: 0,
                      color: "primary",
                      label: props.value
